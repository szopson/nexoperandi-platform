...
export const metadata: Metadata = {
  ...
  description:
    "Dedykowane strony i sklepy internetowe zoptymalizowane pod konwersję. Od stron dla klinik po sklepy WooCommerce — mobile-first, SEO-ready, mierzalne. Od 11 000 zł.",
  alternates: {

    ...
    results: {
      ...
      engagements: {
        support: {
          ...
          headline: '-30–60% kosztów obsługi, odpowiedzi 20–40% szybciej',
          mechanism: 'Asystent AI odpowiada na proste pytania klientów, porządkuje zgłoszenia i przekazuje trudniejsze sprawy do właściwych osób w Twoim zespole.',
          scope: 'Pierwsza linia wsparcia (podstawowe i bardziej złożone pytania)',
          ...
          resultTarget: '-30–60% kosztów obsługi, odpowiedzi 20–40% szybciej',
          modalStack: 'Slack, Jira, Notion/Confluence',
        },
        onboarding: {
          pill: 'Onboarding klientów · US/EU',
          headline: 'Rentowny pierwszy prototyp w 4–6 tygodni',
          mechanism: 'Asystent AI prowadzi nowych klientów krok po kroku, odpowiada na większość ich pytań i zbiera dane potrzebne do uruchomienia usługi.',
          scope: 'Wsparcie nowych klientów przy starcie współpracy',
          stack: 'Integracje z płatnościami (np. Stripe), weryfikacją danych (np. Plaid) i Twoimi systemami wewnętrznymi',
          timeToValue: '4–6 tygodni',
          ...
          resultTarget: '60–80% wdrażania w pełni zautomatyzowane, rentowny pierwszy prototyp w 4–6 tygodni',
          modalStack: 'Stripe, Plaid, Twoje systemy wewnętrzne, Email/SMS',
        },
        revenue: {
          ...
          scope: 'Automatyczna kwalifikacja i obsługa leadów sprzedażowych',
          stack: 'HubSpot/Salesforce, Clearbit, email',

...
export const pagesTranslations = {
  en: {
    ...
    pricing: {
      ...
      tiers: [
        {
          name: 'Starter',
          description: 'For teams getting started with AI pipeline automation.',
          setupPrice: '£1,500', /* REVIEW: pricing */
          monthlyPrice: '£150/mo', /* REVIEW: pricing */
          features: [
            { name: 'Lead capture automation', included: true },
            { name: 'AI chat qualification', included: true },
            { name: 'Basic CRM sync', included: true },
            { name: 'Email support', included: true },
            { name: 'Basic dashboard', included: true },
            { name: 'Voice AI calls', included: false },
            { name: 'Automated proposals', included: false },
        ...
        {
          name: 'Pro',
          description: 'Full pipeline automation with voice AI and proposals.',
          setupPrice: '£2,500', /* REVIEW: pricing */
          monthlyPrice: '£250/mo', /* REVIEW: pricing */
          badge: 'Recommended',
          features: [
            { name: 'Lead capture automation', included: true },
            { name: 'AI chat qualification', included: true },
            ...
            { name: 'Voice AI calls', included: true },
            { name: 'Automated proposals', included: true },
        ...
        },
        {
          ...
          features: [
            ...
            { name: 'Automated proposals', included: true },
            { name: 'Advanced analytics', included: true },
            { name: 'Priority support — 2h response guarantee', included: true },
      ...
      addons: {
        title: 'Add-ons',
        items: [
          { name: 'Multi-channel (WhatsApp, SMS)', price: '+£100/mo' }, /* REVIEW: pricing */
          { name: 'AI Content Engine', price: '+£200/mo' }, /* REVIEW: pricing */
          { name: 'AI Voice Concierge', price: '+£150/mo' }, /* REVIEW: pricing */
  ...
  pl: {
    ...
    pricing: {
      title: 'Cennik',
      subtitle: 'Przejrzyste ceny. Setup + abonament. Bez ukrytych opłat. Rezygnacja w każdej chwili.',
      tiers: [
        {
          name: 'Starter',
          description: 'Dla zespołów rozpoczynających automatyzację AI pipeline.',
          setupPrice: '6 000 zł', /* REVIEW: pricing */
          monthlyPrice: '600 zł/mies.', /* REVIEW: pricing */
          features: [
            { name: 'Automatyzacja pozyskiwania leadów', included: true },
            { name: 'Kwalifikacja AI przez czat', included: true },
            { name: 'Podstawowa synchronizacja z CRM', included: true },
            { name: 'Wsparcie mailowe', included: true },
            { name: 'Podstawowy dashboard', included: true },
            { name: 'Głosowe rozmowy AI', included: false },
            { name: 'Automatyczne oferty', included: false },
            { name: 'Zaawansowana analityka', included: false },
            { name: 'Priorytetowe wsparcie', included: false },
            { name: 'Niestandardowe integracje', included: false },
          ],
          cta: 'Zacznij',
        ...
        {
          name: 'Pro',
          description: 'Pełna automatyzacja pipeline z głosowym AI i ofertami.',
          setupPrice: '10 000 zł', /* REVIEW: pricing */
          monthlyPrice: '1 000 zł/mies.', /* REVIEW: pricing */
          badge: 'Rekomendowany',
          features: [
            { name: 'Automatyzacja pozyskiwania leadów', included: true },
            { name: 'Kwalifikacja AI przez czat', included: true },
            { name: 'Podstawowa synchronizacja z CRM', included: true },
            { name: 'Wsparcie mailowe', included: true },
            { name: 'Zaawansowany dashboard', included: true },
            { name: 'Głosowe rozmowy AI', included: true },
        ...
        },
        {
          ...
          features: [
            ...
            { name: 'Automatyczne oferty', included: true },
            { name: 'Zaawansowana analityka', included: true },
            { name: 'Priorytetowe wsparcie — gwarancja odpowiedzi w 2h', included: true },
            { name: 'Niestandardowe integracje', included: true },
          ],
          cta: 'Skontaktuj się',
          ctaHref: '/pl/contact',
          highlighted: false,
      ...
      addons: {
        title: 'Dodatki',
        items: [
          { name: 'Multi-kanał (WhatsApp, SMS)', price: '+400 zł/mies.' }, /* REVIEW: pricing */
          { name: 'AI Content Engine', price: '+800 zł/mies.' }, /* REVIEW: pricing */
          { name: 'AI Voice Concierge', price: '+600 zł/mies.' }, /* REVIEW: pricing */

...
export default function Results({ lang = 'en' }: ResultsProps) {
  ...
  const engagements = [
    {
      id: 'support',
      pill: t.results.engagements.support.pill,
      headline: t.results.engagements.support.headline,
      mechanism: t.results.engagements.support.mechanism,
      scope: t.results.engagements.support.scope,
      stack: t.results.engagements.support.stack,
      timeToValue: t.results.engagements.support.timeToValue,
      modal: {
        problem: t.results.engagements.support.problem,
        solution: t.results.engagements.support.solution,
        resultTarget: t.results.engagements.support.resultTarget,
        stack: t.results.engagements.support.modalStack,
        timeToValue: t.results.engagements.support.timeToValue,
      },
    },
    {
      id: 'onboarding',
      pill: t.results.engagements.onboarding.pill,
      headline: t.results.engagements.onboarding.headline,
      mechanism: t.results.engagements.onboarding.mechanism,
      scope: t.results.engagements.onboarding.scope,
      stack: t.results.engagements.onboarding.stack,
      timeToValue: t.results.engagements.onboarding.timeToValue,
      modal: {
        problem: t.results.engagements.onboarding.problem,
        solution: t.results.engagements.onboarding.solution,
        resultTarget: t.results.engagements.onboarding.resultTarget,
        stack: t.results.engagements.onboarding.modalStack,
        timeToValue: t.results.engagements.onboarding.timeToValue,
      },
    },
    {
  ...
  return (
    <>
      <section
        id="proof"
        ref={sectionRef}
        className="pt-2 pb-4 md:py-24 bg-white"
      >
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-2 md:gap-4 mb-4 md:mb-8">
            <div>
              <h2 className="text-center md:text-left text-lg md:text-4xl font-semibold leading-snug">
                {t.results.title}
              </h2>
                ...
                >
                  ...
                  <dl className="space-y-2 text-sm text-gray-500 border-t border-gray-100 pt-4">
                    <div className="flex justify-between items-center">
                      <dt className="font-medium">{t.results.scope}</dt>
                    ...
                    <div className="flex justify-between items-center">
                      <dt className="font-medium">{t.results.timeToValue}</dt>
          ...
          <div
            id="guarantee"
            className="mt-6 md:mt-8 rounded-xl md:rounded-2xl border border-slate-200 md:border-2 md:border-blue-100 bg-white md:bg-gradient-to-br md:from-blue-50 md:via-blue-50/50 md:to-transparent p-4 md:p-8 shadow-sm md:shadow-none"
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 md:space-y-3">
                  <li className="flex items-start text-sm md:text-[15px] text-gray-700">
                    <svg className="w-5 h-5 text-blue-600 mr-2 md:mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="flex flex-col justify-between">
                ...
                <a
                  href="#contact"
                  className="w-full md:w-auto inline-flex items-center justify-center bg-blue-600 md:bg-transparent md:border-2 md:border-blue-600 text-white md:text-blue-700 font-semibold py-3 px-6 rounded-md md:rounded-lg hover:bg-blue-700 md:hover:bg-blue-600 md:hover:text-white transition-colors text-sm shadow-md md:shadow-none"
                >

...
export default function DigitalBrain({ lang = 'en' }: DigitalBrainProps) {
  ...
  return (
    <div className="flex lg:justify-end order-1 lg:order-2 w-full h-[500px] md:h-[600px] relative items-center justify-center">
      {/* Central Focus Container */}
      <div className="flex w-full h-[400px] md:h-[500px] max-w-[500px] relative items-center justify-center">

        {/* Connecting Data Pipes (SVG) */}
        ...
        <div className="relative z-30 w-44 h-44 md:w-52 md:h-52 brain-container rounded-3xl flex items-center justify-center group transform transition-transform duration-700 hover:scale-105 border border-cyan-500/20">

          {/* Glowing Corners */}
          <div className="absolute -top-[1px] -left-[1px] w-4 h-4 border-t-2 border-l-2 rounded-tl-xl border-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.5)]" />
          <div className="absolute -top-[1px] -right-[1px] w-4 h-4 border-t-2 border-r-2 rounded-tr-xl border-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.5)]" />
          <div className="absolute -bottom-[1px] -left-[1px] w-4 h-4 border-b-2 border-l-2 rounded-bl-xl border-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.5)]" />
          <div className="absolute -bottom-[1px] -right-[1px] w-4 h-4 border-b-2 border-r-2 rounded-br-xl border-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.5)]" />
          ...
          <div className="relative w-[88%] h-[88%] rounded-2xl overflow-hidden bg-[#020617] flex items-center justify-center border border-white/5">
            ...
            <Image
              ...
              alt="Digital Brain"
              fill
              className="contrast-125 saturate-0 opacity-90 object-cover z-20 scale-125"
            />
          ...
          <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 z-40">
            <div className="bg-[#020617] border border-cyan-500/30 px-3 py-1 rounded-full shadow-[0_0_15px_rgba(6,182,212,0.3)] flex items-center gap-2">
              ...
              <span className="text-[10px] font-mono font-bold text-cyan-400 tracking-[0.1em] uppercase whitespace-nowrap">
        ...
        <div className="absolute top-[8%] left-[0%] sm:-left-[5%] animate-float-delayed z-20">
          <div className="glass-card flex gap-3 w-36 md:w-40 rounded-xl p-3 items-center border-l-2 border-l-blue-500">
            ...
            <div className="flex flex-col min-w-0">
              <span className="text-[9px] text-blue-400 uppercase font-bold tracking-wider">
        ...
        <div className="absolute top-[0%] right-[0%] sm:-right-[5%] animate-float z-20">
          <div className="glass-card p-3 rounded-xl border-l-2 border-l-cyan-500 flex items-center gap-3 w-40 md:w-44 shadow-lg shadow-cyan-900/20">
            <div className="w-8 h-8 rounded-lg bg-cyan-500/10 flex items-center justify-center border border-cyan-500/20 shrink-0">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-cyan-400 animate-spin-slow" style={{ animationDuration: '3s' }}>
        ...
        <div className="animate-float-delayed absolute bottom-[15%] right-[0%] sm:-right-[8%] z-20">
          <div className="glass-card p-3 rounded-xl border-l-2 border-l-indigo-500 flex items-center gap-3 w-36 md:w-40">
            <div className="w-8 h-8 rounded-lg bg-indigo-500/10 flex items-center justify-center border border-indigo-500/20 shrink-0">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-indigo-400">
        ...
        <div className="absolute bottom-[5%] left-[0%] sm:-left-[5%] animate-float z-20">
          <div className="glass-card p-3 rounded-xl border-l-2 border-l-emerald-500 flex items-center gap-3 w-40 md:w-44">
            <div className="w-8 h-8 rounded-lg bg-emerald-500/10 flex items-center justify-center border border-emerald-500/20 shrink-0">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-emerald-400">
                <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
